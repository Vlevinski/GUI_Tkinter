...
photo1 = tk.PhotoImage(file="img/ic_group.png")
photo2 = tk.PhotoImage(file="img/ic_mood.png")
photo3 = tk.PhotoImage(file="img/ic_plus_one.png")
photo4 = tk.PhotoImage(file="img/ic_public.png")
photo5 = tk.PhotoImage(file="img/ic_person_add.png")
photo6 = tk.PhotoImage(file="img/ic_whatshot.png")
photo7 = tk.PhotoImage(file="img/ic_notifications.png")
